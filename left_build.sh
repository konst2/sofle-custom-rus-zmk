...
west build -s app -d build_left -b nice_nano_v2 -- -DSHIELD=sofle_left -DZMK_CONFIG="$CONFIG_DIR/config" -DZMK_EXTRA_MODULES="/Volumes/MiniExtra/Projects/zmk-lang-switch"
